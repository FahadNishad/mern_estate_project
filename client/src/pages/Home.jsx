...
const Home = () => {
  ...
  const [rentLsting, setRentListings] = useState([]);
    ...
    <div>
      ...
      <div className="flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          Fahad Estate is the best place to find your next perfect place to
          live.
          <br />
      ...
      <div className="max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10">
        ...
        {rentLsting && rentLsting.length > 0 && (
          <div>
            <div className="my-3">
